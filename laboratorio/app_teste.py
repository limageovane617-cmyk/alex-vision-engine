...
2️⃣ Usar llama-mtmd-cli

<br><br>

3️⃣ Baixar/carregar SmolVLM
...
async function acompanhar() {
    ...
    try {
        ...
        if (
            ...
            status.innerText =
                "🟢 SmolVLM terminou o teste " +
                "sem erro de processo.";
...
def executar_em_segundo_plano(caminho):
    ...
    comando = [
        ...
        MODEL,
        "-p",
        "Responda apenas: modelo carregado.",
        "-n",
        "16",
        "--temp",
        "0",
